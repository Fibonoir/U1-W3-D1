...
function concatenateStrings(str1, str2){
  ...
  const result = (firstTwoChars + lastThreeChars).toUpperCase();
  return result;
}
...
console.log(getEvenNumbers(testArray))
...
console.log(sumNumbersReduce(testArray));
...
function incrementArrayValues(array, n =Math.floor(Math.random() * 10)) {
  console.log("Il testArray viene aumentato di " + n);
  return array.map((num) => num + n);
}

console.log(incrementArrayValues(testArray));
...
const stringArray = ["Hello", "World", "how","are", "you","doing"];

function getStringLengths(array) {
  return array.map((str) => str.length);
}

console.log(getStringLengths(stringArray));
